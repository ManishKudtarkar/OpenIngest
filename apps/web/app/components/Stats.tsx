...
const METRICS = [
  ...
  { raw: 6,      fmt: (v: number) => v.toString(),                display: "6",       label: "milestones shipped", sub: "v1.0 → v3.0.5",            c: "#14B8A6" },
];
    ...
    <section className="relative py-20 overflow-hidden" ref={ref}>
      ...
      <div className="section-container">
        ...
        <p className="text-center text-[11px] text-[#1E293B] mt-6 f-mono">
          Run ID: OI-20260703-3BB09C · PostgreSQL 15 · Python 3.12 · 17 connectors · 93 tests
        </p>
      </div>
    </section>
  );
